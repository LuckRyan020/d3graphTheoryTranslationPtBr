...
var contentData = // jshint ignore:line
{
  ...
  "degree-of-vertex": {
    ...
    "theory-content": "<p>O <b>grau<\/b> de um vértice é o números de arestas que incidentes a ele. Ele nos diz quantos outros vértices são adjacentes a esse vértice.<\/p><p>No diagrama, cada vértice está rotulado com o seu grau. Faça algumas mudanças e veja como o grau dos vértices muda. <\/p><p>O grau de um vértice \\(v\\) é denotado por \\(deg(v)\\). Os vértices com \\(deg(v)=0\\) são lobos solitários &mdash; sem relação com nenhum outro. Nós temos um nome especial para eles. <\/p><p> Os vértices que possuem <b>grau zero<\/b> são denominados <b>vértices isolados.<\/b> Eles não tem nenhum outro vértice conectado a eles. <\/p><p> O grau mínimo de um grafo \\(G\\) é denotado por \\(\\delta(G)\\). E o grau máximo por \\(\\Delta(G)\\). Para evitar confusão entre eles, lembre que \\(\\delta\\) é o \"delta pequeno\" e \\(\\Delta\\) é o \"grande delta\". <\/p><div class=\"note\"> <span class=\"note-word\">Nota:<\/span> Lemre que \\(\\delta\\) e \\(\\Delta\\) são propriedados de um grafo, enquanto \\(deg\\) é propriedade de um vértice. <\/div>",
